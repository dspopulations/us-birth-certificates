...
class Variables(StrEnum):
    ...
    MAGE36 = "mage36"
    """Age of Mother Recode 36 (pre-2004; present 1989-2002). 01 Under 15, 02 15, 03 16 ... 41 54; single-year bins. The recode was extended from 36 to 41 categories in 1997 - pre-1997 it tops out at code 36 (age 49), from 1997 at code 41 (age 54). In mage_c the +13 offset maps code 01 ("Under 15", a 10-14 bin) to age 14 - a lower-bound approximation that is immaterial above the lowest analytic age boundary (20)."""
    MAGER12 = "mager12"
    ...
    MRACEREC = "mracerec"
    """Mother's Race Recode (2003-2013). 1 White, 2 Black, 3 AIAN, 4 Asian/Pacific Islander; Puerto Rico: 0 Other, 1 White, 2 Black."""
    MRACE31 = "mrace31"
    ...
    UMHISP = "umhisp"
    """Mother's Hispanic Origin, 1989-cert variant (2003-2013 files; position 148; dropped from 2014). 0 Non-Hispanic, 1 Mexican, 2 Puerto Rican, 3 Cuban, 4 Central or South American, 5 Other and Unknown Hispanic, 9 Origin unknown or not stated."""
    MHISPX = "mhispx"
    ...
    MAR = "mar"
    """Mother's Marital Status. The raw column is named MAR only on the 2003-revision files (data years 2003-2013 in our extract); the same item is carried by the DMAR column in 1989-2002 and again from 2014 (see DMAR). US/Virgin Islands/Guam/AS/NMI: 1 Married, 2 Unmarried, 9 Unknown or not stated. Puerto Rico: 1 Married, 2 Unmarried parents living together, 3 Unmarried parents not living together, 9 Unknown or not stated."""
    MAR_P = "mar_p"
    """Paternity Acknowledged (Y Yes, N No, U Unknown, X Not Applicable)."""
    DMAR = "dmar"
    """Marital Status. The DMAR column carries marital status in 1989-2002 and from 2014 onward; the 2003-2013 years are in the MAR column instead (see MAR). US/outlying except PR: 1 Married, 2 Unmarried (9 Unknown or not stated in the 1989-2002 files). Puerto Rico: 1 Married, 2 Unmarried parents living together, 3 Unmarried parents not living together, 9 Unknown or not stated."""
    DMEDUC = "dmeduc"
    """Mother's Education, 1989-cert variant. 00 No formal education, 01-08 elementary years, 09-12 high school years, 13-16 college years, 17 5+ years college, 99 Not stated, Blank Not on certificate. The 1989-cert education item; present 1989-2008 in our extract (it continues through the early dual-layout years, then is dropped). The 2003-cert education item is MEDUC."""
    MEDUC = "meduc"
    ...
    UMEDUC = "umeduc"
    """Mother's Education, 1989-cert variant. The NCHS 2003 transition-file record layout names this item UMEDUC (positions 156-157), but the column is unpopulated in our built extract - the 1989-cert education is carried by DMEDUC (which covers 2003). Codes match DMEDUC: 00 No formal education, 01-08 elementary, 09-12 high school, 13-16 college, 17 5+ years college, 99 Not stated, Blank Not on certificate."""
    MEDUC6 = "meduc6"
    """Education of Mother Recode 6 (pre-2003). 1 0-8 years, 2 9-11 years, 3 12 years, 4 13-15 years, 5 16+ years, 6 Not stated."""
    MEDUC_REC = "meduc_rec"
    """Mother's Education Recode, 1989-cert variant (present 2003-2008 in our extract; same code structure as MEDUC6). 1 0-8 years, 2 9-11 years, 3 12 years, 4 13-15 years, 5 16+ years, 6 Not stated, Blank Not on certificate."""
    MPLBIR = "mplbir"
    """Place of Birth of Mother (1989-cert files, present 1989-2002; replaced by the UMBSTATE/MBSTATE_REC nativity recode from the 2003 revision). 01-51 US states/DC (09 = DC), 52 Puerto Rico, 53 Virgin Islands, 54 Guam, 55 Canada, 56 Cuba, 57 Mexico, 59 Remainder of the World, 61 American Samoa, 62 Northern Marianas, 99 Not classifiable."""
    DFAGE = "dfage"
    ...
    UFAGECOMB = "ufagecomb"
    """Father's Combined Age, 1989-cert variant (2003-cert-era dual-layout files; present 2003-2011 in our extract). 10-98 single years, 99 Unknown or not stated, Blank Not on certificate."""
    FAGECOMB = "fagecomb"
    """Father's Combined Age, 2003 cert. 09-98 single years, 99 Unknown or not stated."""
    FAGEREC11 = "fagerec11"
    """Father's Age Recode 11 (2003+ files, includes both the 1989 and 2003 revisions; present 2003-2024). 01 Under 15, 02 15-19, 03 20-24, 04 25-29, 05 30-34, 06 35-39, 07 40-44, 08 45-49, 09 50-54, 10 55-98, 11 Not stated."""
    FBRACE = "fbrace"
    ...
    FRACEREC = "fracerec"
    """Father's Race Recode (2003-2013). 1 White, 2 Black, 3 AIAN, 4 Asian/Pacific Islander, 9 Unknown or not stated; Puerto Rico adds 0 Other (not classified as White or Black)."""
    UFHISP = "ufhisp"
    """Father's Hispanic Origin, 1989-cert variant (2003-2013 files). 0 Non-Hispanic, 1 Mexican, 2 Puerto Rican, 3 Cuban, 4 Central American (guide wording; equivalent to Central or South American), 5 Other and Unknown Hispanic, 9 Origin unknown or not stated."""
    FRACEHISP = "fracehisp"
    """Father's Race/Hispanic Origin. 2014+ (built from FRACE31/FRACE6/FRACE15): 1-6 as for MRACEHISP, 7 Hispanic, 8 Origin unknown or not stated, 9 Race unknown or not stated (Non-Hispanic). NOTE: the identically named field in 2003-2013 carries the old 1989-cert recode (1 Mexican, 2 Puerto Rican, 3 Cuban, 4 Central or South American, 5 Other/Unknown Hispanic, 6 NH White, 7 NH Black, 8 NH Other Races, 9 Origin unknown) - do not pool the raw codes across the 2014 break."""
    FRACE31 = "frace31"
    ...
    APGAR5 = "apgar5"
    """Five-Minute APGAR Score. 00-10 raw score, 99 Unknown or not stated. Named FMAPS in 1989-2002, renamed APGAR5 from the 2003 revision."""
    APGAR5R = "apgar5r"
    """Five-Minute APGAR Recode. 1 score 0-3, 2 score 4-6, 3 score 7-8, 4 score 9-10, 5 Unknown or not stated. Named FMAPSR in 1989-2002 (where code 5 = Not stated), renamed APGAR5R from the 2003 revision."""
    APGAR10 = "apgar10"
    ...
    DPLURAL = "dplural"
    """Plurality Recode. 1989-2019: 1 Single, 2 Twin, 3 Triplet, 4 Quadruplet, 5 Quintuplet or higher. From 2020 collapsed to four categories with 4 = Quadruplet or higher (no code 5)."""
    ...
    SEX = "sex"
    """Sex of Infant. M Male, F Female (from the 2003 revision; present 2003-2024 in our extract). In 1989-2002 infant sex is the CSEX field (coded 1 Male, 2 Female), which is not imported here."""
    GESTREC10 = "gestrec10"
    """Combined Gestation Recode 10 (2003+; named GESTREC10). 01 Under 20 weeks, 02 20-27, 03 28-31, 04 32-33, 05 34-36, 06 37-38, 07 39, 08 40, 09 41, 10 42+ weeks, 99 Unknown. The 1989-2002 field (named GESTAT10) uses different boundaries (04 32-35, 05 36, 06 37-39, 07 40, 08 41, 09 42+) with 10 = Not stated (no 99)."""
    DBWT = "dbwt"
    """Birth Weight in grams (edited). 0227-8165 grams, 9999 Not stated birth weight. Named DBIRWT in 1989-2002, renamed DBWT from the 2003 revision."""
    DWGT_R = "dwgt_r"
    """Delivery Weight Recode (pounds). 100-400 weight in pounds, 999 Unknown or not stated."""
    AB_AVEN1 = "ab_aven1"
    """Assisted Ventilation (immediately), 2003 cert. Y Yes, N No, U Unknown or not stated, Blank Not on certificate (non-reporting area)."""
    AB_AVEN6 = "ab_aven6"
    """Assisted Ventilation > 6 hrs, 2003 cert. Y Yes, N No, U Unknown or not stated, Blank Not on certificate (non-reporting area)."""
    AB_NICU = "ab_nicu"
    """Admission to NICU, 2003 cert. Y Yes, N No, U Unknown or not stated, Blank Not on certificate (non-reporting area)."""
    AB_SURF = "ab_surf"
    """Newborn Surfactant Replacement (NCHS field name "Surfactant"), 2003 cert. Y Yes, N No, U Unknown or not stated, Blank Not on certificate (non-reporting area)."""
    AB_ANTI = "ab_anti"
    """Antibiotics for Newborn, 2003 cert. Y Yes, N No, U Unknown or not stated, Blank Not on certificate (non-reporting area)."""
    AB_SEIZ = "ab_seiz"
    """Seizures (newborn), 2003 cert. Y Yes, N No, U Unknown or not stated, Blank Not on certificate (non-reporting area)."""
    NO_ABNORM = "no_abnorm"
    """No Abnormal Conditions Checked. 1 True, 0 False, 9 Not Reported."""
    CA_ANEN = "ca_anen"
    """Anencephaly (2003 cert). Y Yes (anomaly reported), N No (anomaly not reported), U Unknown or not stated, Blank Not on certificate (non-reporting area)."""
    CA_MNSB = "ca_mnsb"
    """Meningomyelocele / Spina Bifida (2003 cert). Y Yes (anomaly reported), N No (anomaly not reported), U Unknown or not stated, Blank Not on certificate (non-reporting area)."""
    CA_CCHD = "ca_cchd"
    """Cyanotic Congenital Heart Disease (2003 cert). Y Yes (anomaly reported), N No (anomaly not reported), U Unknown or not stated, Blank Not on certificate (non-reporting area)."""
    CA_CDH = "ca_cdh"
    """Congenital Diaphragmatic Hernia (2003 cert). Y Yes (anomaly reported), N No (anomaly not reported), U Unknown or not stated, Blank Not on certificate (non-reporting area)."""
    CA_OMPH = "ca_omph"
    """Omphalocele (2003 cert). Y Yes (anomaly reported), N No (anomaly not reported), U Unknown or not stated, Blank Not on certificate (non-reporting area)."""
    CA_GAST = "ca_gast"
    """Gastroschisis (2003 cert). Y Yes (anomaly reported), N No (anomaly not reported), U Unknown or not stated, Blank Not on certificate (non-reporting area)."""
    CA_LIMB = "ca_limb"
    """Limb Reduction Defect (2003 cert). Y Yes (anomaly reported), N No (anomaly not reported), U Unknown or not stated, Blank Not on certificate (non-reporting area)."""
    CA_CLEFT = "ca_cleft"
    """Cleft Lip w/ or w/o Cleft Palate (2003 cert). Y Yes (anomaly reported), N No (anomaly not reported), U Unknown or not stated, Blank Not on certificate (non-reporting area)."""
    CA_CLPAL = "ca_clpal"
    """Cleft Palate alone (2003 cert). Y Yes (anomaly reported), N No (anomaly not reported), U Unknown or not stated, Blank Not on certificate (non-reporting area)."""
    DOWNS = "downs"
    ...
    DMETH_REC = "dmeth_rec"
    """Delivery Method Recode (collapsed). 1 Vaginal, 2 C-Section, 9 Unknown. This
    collapsed form applies from 2006 in our extract; in 2003-2004 the same column is
    instead the DETAILED recode (1 Vaginal, 2 VBAC, 3 Primary C-section, 4 Repeat
    C-section, 5 Not stated, 6 Vaginal unknown-if-previous, 7 C-section
    unknown-if-previous) and it is absent in 2005 - the detailed role passes to
    RDMETH_REC/UDMETH_REC from 2005. Note code 5 = Not stated in the 2003-2004 detailed
    form, not Unknown."""
    ATTEND = "attend"
    ...
    YEAR = "year"
    """Birth year harmonised across eras: COALESCE(dob_yy, datayear). dob_yy is the
    4-digit Year of Birth on 2003-revision files (present 2003 onward, including the
    2003 transition file); datayear is the 1989-revision Year Birth of Child (positions
    1-4, present 1989-2002). The two never co-occur, so the COALESCE is unambiguous."""

    MAGE_C = "mage_c"
    """Combined maternal age in single years, harmonised across eras via
    COALESCE(mager, dmage, mage36 + 13, mager41 + 13). mager (2004+) and dmage (<=2002)
    are already single-year ages; mage36 (<=2002 recode) and mager41 (2003 transition
    file only) share the 41-category coding (01 "Under 15", 02 "15 years", ... 41 "54
    years"), so adding 13 maps each code to its single-year age. The 2003 file carries
    none of mager/dmage/mage36, so mager41 is its only single-year source. Code 01 (the
    10-14 "Under 15" bin) maps to 14, a lower-bound approximation that is immaterial
    above the lowest analytic age boundary (20)."""
    ...
    NB: selection.data gives code 6 (NH multi-race) its own model group (race_idx 6);
    only NULL/other races fall to the Unknown bucket (idx 5). De Graaf has no multi-race
    anchor, so idx 6 carries the same weak s(race, year) fallback as Unknown."""
