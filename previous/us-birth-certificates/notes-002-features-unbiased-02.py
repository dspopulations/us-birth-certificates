...
features = [
    ...
    "bmi",
    "pay_rec", "wic" # removed meduc, feduc, mrace6, frace6, mhisp_r, fhisp_r
]
...
categorical = [
    ...
    "no_risks", "ld_indl", "me_pres", "dmeth_rec",
    "ca_disor", "ca_cchd", "ca_cdh", "ca_omph", "pay_rec", "wic"
]
...
params = {
    ...
    # switch away from GOSS
    "data_sample_strategy": "bagging",   # or omit this line entirely
    # (remove top_rate / other_rate)

    # enable row bagging (without replacement)
    "bagging_fraction": 0.75,            # e.g. 0.6–0.9
    "bagging_freq": 5,                   # resample every k iterations; >0 enables it
    "bagging_seed": 42,

    # keep / tune these as usual
